...
namespace BTL
{
    public partial class trangchu : Form
    {
        ...
        {
            chitietphongphieu chitiethoadon = new chitietphongphieu();
            chitiethoadon.Show();
        ...
        {
            lbl_ndtenkhach1.Text = chitietphongphieu.truyenthongtin.tenkhach;
            lbl_ndsokhach1.Text = chitietphongphieu.truyenthongtin.sokhach;
            lbl_ndquoctich1.Text = chitietphongphieu.truyenthongtin.quoctich;
            lbl_ndngayden1.Text = chitietphongphieu.truyenthongtin.ngayden;
            lbl_ndngaydi1.Text = chitietphongphieu.truyenthongtin.ngaydi;
