...
namespace BTL
{
    public partial class quanlynv : Form
    {
        ...
        {
            capnhatlichlamviec fcatnhatlich = new capnhatlichlamviec();
            fcatnhatlich.Show();
            this.Hide();
        }
        SqlConnection conn = new SqlConnection(@"Data Source=desktop-7nnbdsh\nthoa;Initial Catalog=QLkhachsan;Integrated Security=True");
        public void hienthi()
        {
            conn.Open();
        ...
        private void button_quaylai_Click_1(object sender, EventArgs e)
        {
